programa
{
	...
	funcao inicio()
	{
		...
		efetuarJogada(nome2,2,0,simboloO,tabuleiro)
		ganhou = verificaSeGanhou(tabuleiro, simboloO)
		
		efetuarJogada(nome1,1,1,simboloX,tabuleiro)
		ganhou = verificaSeGanhou(tabuleiro, simboloX)
		
		efetuarJogada(nome2,2,2,simboloO,tabuleiro)
		ganhou = verificaSeGanhou(tabuleiro, simboloO)
		
		efetuarJogada(nome1,2,1,simboloX,tabuleiro)
		ganhou = verificaSeGanhou(tabuleiro, simboloX)
		
		efetuarJogada(nome2,0,1,simboloO,tabuleiro)
		ganhou = verificaSeGanhou(tabuleiro, simboloO)
		
		efetuarJogada(nome1,1,2,simboloX,tabuleiro)
		ganhou = verificaSeGanhou(tabuleiro, simboloX)

		efetuarJogada(nome1,1,0,simboloO,tabuleiro)
		ganhou = verificaSeGanhou(tabuleiro, simboloO)

		efetuarJogada(nome1,0,2,simboloX,tabuleiro)
		ganhou = verificaSeGanhou(tabuleiro, simboloX)
